...
#The raw tumour counts are also saved in a seperate file
write.csv(data.frame(counts(tumDESeqData, normalized = FALSE)), file = "./Data/InVivo Tumour Raw Count Matrix.csv" )
